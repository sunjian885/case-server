...
//    ExecRecord execRecord;
    ...
    public RecordEntity(String roomId, Long caseId, TestCaseMapper caseMapper, CaseBackupMapper caseBackupMapper, Long recordId, ExecRecordMapper execRecordMapper) {
        super(roomId, caseId, caseMapper,caseBackupMapper);
    ...
    public void removeClient(SocketIOClient client) {
        ...
        //LOGGER.info("removeClient testCase.getCaseContent():" + testCase.getCaseContent());

        //只有在链接断开的情况下才会更新excuceRecord
        JSONObject jsonObject = TreeUtil.parse(testCase.getCaseContent());
        //LOGGER.info("removeClient testCase jsonObject:" + jsonObject);
    ...
    private String mergeRecord(Long recordId, String caseContentStr, ExecRecordMapper execRecordMapper) {
        ...
        //LOGGER.info("mergeRecord caseContentStr ={}",caseContentStr);
        ...
        //LOGGER.info("mergeRecord record.getCaseContent() ={}",record.getCaseContent());
