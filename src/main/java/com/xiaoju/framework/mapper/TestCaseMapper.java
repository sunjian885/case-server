...
public interface TestCaseMapper {
    ...
    List<TestCase> searchByCreator(@Param("creator") String creator);

    List<TestCase> getTestCasesByCreator(@Param("creator") String creator,
                                         @Param("gmtCreatedBegin") Date gmtCreatedBegin,
    ...
    List<TestCase> searchAmountsByUserids(@Param("usernames") List<String> usernames,
                                          @Param("gmtCreatedBegin") Date gmtCreatedBegin,
                                          @Param("gmtCreatedEnd") Date gmtCreatedEnd);

    List<TestCase> getAllCases();

    int updateTestCaseCreatorId(@Param("creatorId") Long creatorId,@Param("creator") String creator);

    int updateTestCaseModifierId(@Param("modifierId") Long modifierId,@Param("modifier") String modifier);
}