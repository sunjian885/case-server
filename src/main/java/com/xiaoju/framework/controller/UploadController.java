...
public class UploadController {
    ...
    public Response<Long> importXmind(@RequestParam MultipartFile file, String creator, String bizId,
                                      Long productLineId, String title, String description, Integer channel,String requirements, String requirementId, HttpServletRequest request) {
        FileImportReq req = new FileImportReq(file, creator, productLineId, title, description, channel, requirementId, requirements, bizId);
        req.validate();
        try {
    ...
    public Response<Long> importExcel(@RequestParam MultipartFile file, String creator, String bizId,
                                      Long productLineId, String title, String description, Integer channel, String requirementId, String requirements,HttpServletRequest request) {
        FileImportReq req = new FileImportReq(file, creator, productLineId, title, description, channel, requirementId,requirements, bizId);
        req.validate();
        try {
