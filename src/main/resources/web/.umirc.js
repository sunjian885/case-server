...
const proxy =
  NODE_ENV !== 'production'
    ? {
        '/api': {
          target: `http://case-in.test.shantaijk.cn`, //线上环境
  ...
  routes: [
    {
      ...
      routes: [
        ...
        {
          path: '/rol',
          component: './registerorlogin/index.jsx',
        },
        {
          path: '/caseview',
          component: './caseview/index.jsx',
        },
        {
          path: '/ai',
          component: './aiCase/index.jsx',
          routes:[
            {
              exact: true,
              path: '/ai',
              // component: './landing/index.jsx',
              redirect: '/ai/generateCase',
            },
            {
              path: '/ai/generateCase',
              component: './aiCase/AIService/AIGenerate/AIGenerate.jsx',
            },
            {
              path: '/ai/queryAICases',
              component: './aiCase/AIService/AIQuery/AIQuery.jsx',
            },
          ]
        },
        {
